				...
				<div class="d-flex align-items-center mt-5">
					...
					<div class="d-flex flex-column">
						...
						<div class="navi mt-2">
							...
							<?php if ($user->isSuperAdmin($user->currentUser->id) || $user->isAdmin($user->currentUser->id) || $user->isStaffAdmin($user->currentUser->id)) { ?>
								<?php if($utility->accessAdmin()){ ?>
									<a href="<?php echo BASE_URL.USER_ROOT?>" class="btn btn-sm btn-light-warning font-weight-bolder py-2 px-5">Switch</a>
								<?php } else { ?>
									<a href="<?php echo BASE_URL.ADMIN_ROOT?>" class="btn btn-sm btn-light-warning font-weight-bolder py-2 px-5">Switch</a>
								<?php } ?>
							<?php } ?>
				...
				<div class="navi navi-spacer-x-0 p-0">
					...
					<a href="<?php echo BASE_URL.USER_ROOT?>my-profile" class="navi-item">
						<div class="navi-link">
							...
							<div class="navi-text">
								...
								<span class="label label-light-danger label-inline font-weight-bold">new</span></div>
							</div>
						</div>
					</a>
					<!--end:Item-->
					...
					<a href="<?php echo BASE_URL.USER_ROOT?>sales" class="navi-item">
						<div class="navi-link">
							...
							<div class="navi-text">
								<div class="font-weight-bold">My Sales</div>
								<div class="text-muted">All sales transactions</div>
							</div>
						</div>
					</a>
					<!--end:Item-->
					...
					<a href="<?php echo BASE_URL.USER_ROOT?>sales-history" class="navi-item">
						<div class="navi-link">
							...
							<div class="navi-text">
								<div class="font-weight-bold">Sales History</div>
								<div class="text-muted">All sales transactions</div>
							</div>
						</div>
					</a>
					...
					<a href="<?php echo BASE_URL.USER_ROOT?>update-profile" class="navi-item">
						<div class="navi-link">
							...
							<div class="navi-text">
								...
								<div class="text-muted">Profile details update</div>
							</div>
						</div>
					</a>
					<!--end:Item-->
