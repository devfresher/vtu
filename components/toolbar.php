									...
									<div id="kt_header_menu" class="header-menu header-menu-left header-menu-mobile header-menu-layout-default">
											...
											<ul class="menu-nav">
													...
													<div class="menu-submenu menu-submenu-classic menu-submenu-left">
														<ul class="menu-subnav">
															...
															<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
																<a href="<?php echo BASE_URL.ADMIN_ROOT?>share-money" class="menu-link">
																	<span class="svg-icon menu-icon">
																		<!--begin::Svg Icon-->
																			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																				<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																	...
																	<span class="menu-text">Member Info</span>
																</a>
															</li>
	
															<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
																<a href="<?php echo BASE_URL.ADMIN_ROOT?>commission" class="menu-link">
																	<span class="svg-icon menu-icon">
																		<!--begin::Svg Icon -->
																		<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																		<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																	...
																	<span class="menu-text">Member Stats</span>
																</a>
															</li>
															...
															<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
																<a href="<?php echo BASE_URL.ADMIN_ROOT?>pricing" class="menu-link">
																	...
																	<span class="menu-text">SMS Member</span>
																</a>
															</li>
														</ul>
													</div>
												...
												<li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click" aria-haspopup="true">
													...
													<div class="menu-submenu menu-submenu-classic menu-submenu-left">
														<ul class="menu-subnav">
															<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
																<a href="<?php echo BASE_URL.ADMIN_ROOT?>cable-tv" class="menu-link">
																	<span class="svg-icon menu-icon">
															...
															<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
																<a href="<?php echo BASE_URL.ADMIN_ROOT?>electricity" class="menu-link">
																	...
																	<span class="menu-text">Monify Payment</span>
																</a>
															</li>
															...
															<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
																<a href="<?php echo BASE_URL.ADMIN_ROOT?>electricity" class="menu-link">
																	...
																	<span class="menu-text">Flutterwave Payment</span>
																</a>
															</li>
															...
															<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
																<a href="<?php echo BASE_URL.ADMIN_ROOT?>electricity" class="menu-link">
																	...
																	<span class="menu-text">Refund Center</span>
																</a>
															</li>
															...
															<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
																<a href="<?php echo BASE_URL.ADMIN_ROOT?>electricity" class="menu-link">
																	...
																	<span class="menu-text">Requery History</span>
																</a>
															</li>
														</ul>
													</div>
												...
												<li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click" aria-haspopup="true">
													<a href="javascript:;" class="menu-link menu-toggle">
														<span class="menu-text">Sales & Bonuses</span>
														<span class="menu-desc"></span>
														<i class="menu-arrow"></i>
													</a>
													<div class="menu-submenu menu-submenu-classic menu-submenu-left">
														<ul class="menu-subnav">
															<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
																<a href="<?php echo BASE_URL.ADMIN_ROOT?>mtn-data" class="menu-link">
																	<span class="svg-icon menu-icon">
																		<!--begin::Svg Icon-->
																		<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																			<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																	...
																	<span class="menu-text">This Year Sales</span>
																</a>
															</li>
															...
															<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
																<a href="<?php echo BASE_URL.USER_ROOT?>other-bundles" class="menu-link">
																	...
																	<span class="menu-text">Member Daily Sales</span>
																</a>
															</li>
	
															<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
																<a href="<?php echo BASE_URL.USER_ROOT?>databundles" class="menu-link">
																	<span class="svg-icon menu-icon">
																		<!--begin::Svg Icon | path:assets/media/svg/icons/Shopping/Box2.svg-->
																		<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																			<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																	...
																	<span class="menu-text">Referral Bonus</span>
																</a>
															</li>

															<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
																<a href="<?php echo BASE_URL.ADMIN_ROOT?>databundles" class="menu-link">
																	<span class="svg-icon menu-icon">
																		<!--begin::Svg Icon | path:assets/media/svg/icons/Shopping/Box2.svg-->
																		<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																			<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
														...
														<ul class="menu-subnav">
															<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
																<a href="<?php echo BASE_URL.USER_ROOT?>bulk-sms" class="menu-link">
																	...
																	<span class="menu-text">Super Dashboard</span>
																</a>
															</li>
															...
															<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
																<a href="<?php echo BASE_URL.USER_ROOT?>waec-result-checker" class="menu-link">
																	...
																	<span class="menu-text">Modify Status</span>
																</a>
															</li>
															...
															<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
																<a href="<?php echo BASE_URL.USER_ROOT?>waec-result-checker" class="menu-link">
																	...
																	<span class="menu-text">Post Bill Management</span>
																</a>
															</li>
															...
															<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
																<a href="<?php echo BASE_URL.USER_ROOT?>waec-result-checker" class="menu-link">
																	...
																	<span class="menu-text">Admin Withdrawal</span>
																</a>
															</li>
														</ul>
													</div>
										...
										<?php } else {?>
											<ul class="menu-nav">
														...
														<ul class="menu-subnav">
															...
															<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
																<a href="<?php echo BASE_URL.USER_ROOT?>share-money" class="menu-link">
																	...
																	<span class="menu-text">Share Money</span>
																</a>
															</li>
												...
												<li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click" aria-haspopup="true">
													<a href="javascript:;" class="menu-link menu-toggle">
														<span class="menu-text">Data Bundles</span>
														<span class="menu-desc"></span>
														<i class="menu-arrow"></i>
													</a>
													<div class="menu-submenu menu-submenu-classic menu-submenu-left">
														<ul class="menu-subnav">
															<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
																<a href="<?php echo BASE_URL.USER_ROOT?>mtn-data" class="menu-link">
																	...
																	<span class="menu-text">MTN Bundles</span>
																</a>
															</li>
															...
															<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
																<a href="<?php echo BASE_URL.USER_ROOT?>other-bundles" class="menu-link">
																	...
																	<span class="menu-text">Other GSM Bundles</span>
																</a>
															</li>
															...
															<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
																<a href="<?php echo BASE_URL.USER_ROOT?>databundles" class="menu-link">
																	...
																	<span class="menu-text">Broadband Bundles</span>
																</a>
															</li>
														</ul>
													</div>
														...
														<ul class="menu-subnav">
															<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
																<a href="<?php echo BASE_URL.USER_ROOT?>cable-tv" class="menu-link">
																	...
																	<span class="menu-text">Cable TV</span>
																</a>
															</li>
														...
														<ul class="menu-subnav">
															...
															<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
																<a href="<?php echo BASE_URL.USER_ROOT?>waec-result-checker" class="menu-link">
																	...
																	<span class="menu-text">WAEC Result Checker</span>
																</a>
															</li>
														</ul>
													</div>
								...
								<div class="dropdown">
									...
									<div class="topbar-item">
										<div class="btn btn-icon btn-hover-transparent-white d-flex align-items-center btn-lg px-md-2 w-md-auto" id="kt_quick_user_toggle">
											...
											<span class="text-white opacity-90 font-weight-bolder font-size-base d-none d-md-inline mr-4"><?php echo $user->currentUser->firstname?></span>
											<span class="symbol symbol-35">
												<span class="symbol-label text-white font-size-h5 font-weight-bold bg-white-o-30"><?php echo $user->currentUser->firstLetter?></span>
											</span>
										</div>
									</div>
									<!--end::Toggle-->
